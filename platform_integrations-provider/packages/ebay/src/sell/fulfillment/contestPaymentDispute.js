...
const contestPaymentDispute = async (params) => {
  try {
    ...
    const axiosConfig = {
      method: 'post',
      url: `ttps://apiz.ebay.com/sell/fulfillment/v1/payment_dispute/${payment_dispute_id}/contest`,
      headers: {
...
module.exports = contestPaymentDispute